...
def training(trainloader, model, optimizer, criterion):
...
if __name__ == '__main__':
    ...
    new_trainloader = data_setting(trainloader)
    # new_trainloader = trainloader
    ...
    training(train_loader, model.classifier, optimizer, criterion)
