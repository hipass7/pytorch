...
if __name__ == '__main__':
    ...
    trainset = torch.utils.data.TensorDataset(images[:9500], labels[:9500])
    smoteset = torch.utils.data.TensorDataset(Variable(images[9500:]), Variable(labels[9500:]))
